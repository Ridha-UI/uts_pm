          ...
          child: Column(children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  SizedBox(width: 15,),
                  bestAgents(name: "Ridha", value: 190),
                  SizedBox(width: 15,),
                  bestAgents(name: "romlah", value: 123),
                  SizedBox(width: 15,),
                  bestAgents(name: "cae", value: 111),
                  SizedBox(width: 15,),
                  bestAgents(name: "mando", value: 450),
                  SizedBox(width: 15,),
                  bestAgents(name: "solong", value: 250),
                  SizedBox(width: 15,),
                  bestAgents(name: "kojai", value: 25),
                  SizedBox(width: 15,),
                ],
              ),
            ),
              ...
              child: Column(
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        cities(title: "Kuala ceurape", value: 194),
                        SizedBox(height: 15,),
                        cities(title: "Geunteut", value: 89400),
                        SizedBox(height: 15,),
                        cities(title: "ulee Tanoeh", value: 184000),
                        SizedBox(height: 15,),
                        cities(title: "Labuhan", value: 8300),
                        SizedBox(height: 15,),
                        cities(title: "lam atot", value: 55),
                        SizedBox(height: 15,),
                      ],
                    ),
                  ),
